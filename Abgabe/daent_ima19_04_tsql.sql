...
-- Prozedur 2
-- Kurzbeschreibung: Änder den Status eines Tickets und verringert die ticket_queue eines Agenten falls ein ticket gelöst wird.
...
SELECT * FROM ticket
EXEC dbo.sp_changeStatus 342422,1,@select = 1
SELECT * FROM ticket
-- Variante 1 mit Ergebnis AB
SELECT * FROM dbo.staff
SELECT * FROM ticket
EXEC dbo.sp_changeStatus 2,3,@select = 1
-- Variante 2 mit Ergebnis CD
-- ...
...
EXEC dbo.sp_CreateUser 'dwori420', 'Pa55w.rd!', 'Lukas', 'Dworacek',1, 'Eckertstraße 30i','Eckertstraße 30i','lukas.dworacek@edu.fh-joanneum.at','06505203775',@agent = 1, @select = 1;
SELECT * FROM dbo.customers;
SELECT * FROM dbo.staff;
EXEC dbo.sp_loginUser 'dwori420', 'Pa55w.rd!',1,@select = 1;

EXEC dbo.sp_LoginUser 'dwori420','Pa55wf.rd!',1, @select = 1
